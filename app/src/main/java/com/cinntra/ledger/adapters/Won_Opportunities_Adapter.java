...
import com.cinntra.ledger.fragments.Opportunity_Update_Fragment;
...
public class Won_Opportunities_Adapter extends RecyclerView.Adapter<Won_Opportunities_Adapter.ViewHolder> {
    Context context;
    List<OpportunityItem> itemsList;
    boolean click = true;
    public Won_Opportunities_Adapter(Context context, List<OpportunityItem> itemsList)
        {
