...
public class RecentOrderAdapter extends RecyclerView.Adapter<RecentOrderAdapter.ViewHolder> {
    Context context;
    ArrayList<QuotationItem> recentlist ;
    public RecentOrderAdapter(Context context, List<QuotationItem> recentlist)
      {
    this.context    = context;
    this.recentlist    = (ArrayList<QuotationItem>) recentlist;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
      {
        ...
        holder.title.setText(recentlist.get(position).getCardName());
        holder.details.setText(recentlist.get(position).getComments());
