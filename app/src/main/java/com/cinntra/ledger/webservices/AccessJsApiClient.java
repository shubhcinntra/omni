...
public class AccessJsApiClient {
    private static AccessJsApiClient ourInstance = new AccessJsApiClient();
    ...
    public AccessJsApiClient() {}

    public static AccessJsApiClient getInstance()
     {
    return ourInstance;
     }
    ...
    if (mRetrofitBuilder == null)
            ...
            mRetrofitBuilder = new Retrofit.Builder()
              .baseUrl(Globals.Acess_Js_BaseURL).client(httpClient)
