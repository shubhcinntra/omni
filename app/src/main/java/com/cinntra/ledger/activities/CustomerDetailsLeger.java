...
import com.cinntra.ledger.fragments.Invoices_All_Fragment;
...
public class CustomerDetailsLeger extends MainBaseActivity implements View.OnClickListener {
    ...
    private void setDefaults() {
        ...
        String cardCode =getIntent().getStringExtra("cardCode");
