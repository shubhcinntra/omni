...
public class GraphPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position)
        ...
        if (position == 1)
            managebyShubh(view, container, MainActivity_B2C.Receiptentries);
        if (position == 2)
    ...
    private void managebyShubhReceivable(View view, ViewGroup container, List<BarEntry> entries)
        ...
        CustomMarkerViewReceivables markerView = new CustomMarkerViewReceivables(context, R.layout.barchart_marker, MainActivity_B2C.ReceivableentriesForMarker);
