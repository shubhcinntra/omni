...
public class HorizontalPickerRecyclerView extends RecyclerView implements OnItemClickedListener, View.OnClickListener {
   ...
   setDate(new DateTime());
    ...
    public void scrollToPosition(int position) {
       ...
       // layoutManager.getChildAt(position).setBackgroundDrawable(getResources().getDrawable(R.drawable.background_day_selected));
    }
    public static  int OnScrollPosition = 0;
