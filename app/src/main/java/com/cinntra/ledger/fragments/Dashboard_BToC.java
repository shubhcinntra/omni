...
public class Dashboard_BToC extends Fragment implements View.OnClickListener, ChangeTeam {
    ...
    public static Dashboard_BToC newInstance(String param1, String param2)
     {
    Dashboard_BToC fragment = new Dashboard_BToC();
    ...
    View v=inflater.inflate(R.layout.fragment_dashboard_b2c, container, false);
