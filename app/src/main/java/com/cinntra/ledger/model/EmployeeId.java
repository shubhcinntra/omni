...
public class EmployeeId implements Parcelable
{
    ...
    public final static Creator<EmployeeId> CREATOR = new Creator<EmployeeId>() {


        @SuppressWarnings({
                "unchecked"
        })
        public EmployeeId createFromParcel(android.os.Parcel in) {
            return new EmployeeId(in);
        }

        public EmployeeId[] newArray(int size) {
            return (new EmployeeId[size]);
        }

    }
            ;

    protected EmployeeId(android.os.Parcel in) {
     ...
     * @param timestamp
     */
    public EmployeeId(Integer id, String companyID, String salesEmployeeCode, String salesEmployeeName, String employeeID, String userName, String password, String firstName, String middleName, String lastName, String email, String mobile, String role, String position, String branch, String active, String passwordUpdatedOn, String lastLoginOn, String logedIn, String reportingTo, String timestamp) {
        super();
        this.id = id;
