...
public class ChatModel implements Parcelable
{
    ...
    public final static Creator<ChatModel> CREATOR = new Creator<ChatModel>() {
        ...
        public ChatModel createFromParcel(android.os.Parcel in) {
            return new com.cinntra.ledger.model.ChatModel(in);
        }

        public com.cinntra.ledger.model.ChatModel[] newArray(int size) {
            return (new com.cinntra.ledger.model.ChatModel[size]);
        }
