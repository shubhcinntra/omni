...
public class CreateContactData implements Serializable
{
    ...
    private final static long serialVersionUID = -3915362208323841019L;
     ...
     * @param createDate
     */
    public CreateContactData(String title, String firstName, String middleName, String lastName, String position, String address, String mobilePhone, String fax, String eMail, String remarks1, String dateOfBirth, String gender, String profession, String cardCode, String uBpid, String uBranchid, String uNationalty, String createDate, String createTime, String updateDate, String updateTime) {
        super();
        this.title = title;
